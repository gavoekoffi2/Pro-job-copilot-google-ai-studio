...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:items-center lg:justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-purple-700 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-white">Your AI Career Partner</h2>
          <p className="mt-4 text-lg text-primary-100">
            Join thousands of professionals who use ProJob to land their dream roles faster.
          </p>
          <div className="mt-8 space-y-3">
            {[
              'AI-optimized resumes that beat ATS',
              'Personalized interview coaching',
              'Smart application tracking',
            ].map((item) => (
              <div key={item} className="flex items-center justify-center gap-2 text-primary-100">
